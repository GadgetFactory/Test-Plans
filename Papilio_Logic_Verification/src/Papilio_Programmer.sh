...
sleep 1
		...
		case $device_id in
			...
			XC6SLX4)
				...
				quickstartbitfile=Quickstart-Papilio_Logic_LX4-v1.5.bit
				memtestbitfile=Papilio_Logic_Memory_Test_LX4.bit				
				;;			
			XC6SLX9)
				echo "Papilio Plus LX9 detected"
				bitfile=Papilio_Test_Plan_Board_Under_Test_LX9.bit
				bscan_bitfile=bscan_spi_xc6slx9.bit
				quickstartbitfile=Quickstart-Papilio_Logic_LX9-v1.5.bit
				memtestbitfile=Papilio_Logic_Memory_Test_LX9.bit				
				;;						
			*)
...
echo
echo
echo "Step 1 - The Memory Test has been loaded to the Papilio, please complete the test in Hyperterminal before proceeding."
